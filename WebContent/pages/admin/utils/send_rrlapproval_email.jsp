...
<moot:moothead title='Utilities - Send RRL Approval Email'>
...
<h2>Send RRL Approval Email</h2>

<%

String msg = "";
if(request.getParameter("appid")!=null) {
	msg = "RRL Aproval Email Sent to AppID = "+ request.getParameter("appid");
}

final DbManager dbm = new DbManager("jdbc/moot");
dbm.open();

final DbConnect dbc = dbm.doQuery("SELECT rover_id, CONCAT(first_name,' ',last_name) AS full_name FROM rover WHERE rrl_aprove = 'P'");
...
<table width='100%' cellpadding='0' cellspacing='0' border='0'>
	<tr>
		...
		<td valign='top' width='80%'>
			...
			<form action='/moot/servlet/admin/SendRRLApprovalEmail' method='POST'>
