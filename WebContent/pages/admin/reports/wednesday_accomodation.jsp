...
<moot:mootreport name="Wednesday Accomodation">

<%@page import="redcloud.db.*" %>

<h2>Wednesday Accomodation</h2>
<%
final DbManager dbm = new DbManager("jdbc/moot");
dbm.open();

final DbConnect dbc = dbm.doQuery("SELECT rover_id, CONCAT(first_name,' ',last_name) AS full_name, email, rover_crew FROM rover WHERE need_accomodation='Y'");
