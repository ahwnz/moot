...
<br><br>
For more information see <a href='http://www.heromoot.com/merch.html' target='_blank' title='Merchandise'>Merchandise.</a>
<br><br>
...
%>
	<tr>
		...
		<td align='center'><div id="total_<%=item_id%>">$<%=total%></div></td>
	</tr>

<% } %>


<tr><th colspan='4' align='right'>Total:</th><td align='center'><div id='grand_total'>$<%=grand_total%></div></td></tr>
