...
public class AddTeamMember extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        final int teamNum = Integer.parseInt(request.getParameter("tnum"));
        ...
        final DbConnect dbc = dbm.createPreparedStatement("INSERT INTO rover_team VALUES (null,?,?)");
        dbc.setInt(1, rover_id);
        dbc.setInt(2, teamNum);
        dbc.executeUpdate();

        response.setContentType("text/html");
        PrintWriter out = response.getWriter();
        out.print(GetTeam.getTeam(dbm, teamNum));
        out.flush();
