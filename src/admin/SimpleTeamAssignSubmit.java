...
public class SimpleTeamAssignSubmit extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        final DbConnect dbc1 = dbm.doQuery("SELECT rover_id FROM rover WHERE valid='Y' ORDER BY rover_id");
        final DbConnect dbc2 = dbm.createPreparedStatement("INSERT INTO rover_team VALUES (null,?,?)");

        int count = 0;
        while(dbc1.next()) {
            dbc2.setInt(1, dbc1.getInt("rover_id"));
            dbc2.setInt(2, (count%team_count)+1);
