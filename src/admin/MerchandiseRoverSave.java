...
/**
 * Servlet implementation class MerchandiseRoverSave
 */
public class MerchandiseRoverSave extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MerchandiseRoverSave() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("/moot/pages/admin/merchandise.jsp?order=&oc=a");
	}
